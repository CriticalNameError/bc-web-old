  ...
  return (
    <>
      ...
      <>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div class="container" style={{ maxWidth: "100%" }}>
                  <div class="row my-auto">
                    <div class="col-lg-6 col-md-7 me-lg-auto position-relative my-auto">
                      <p class="text-md mb-1">// 3 oder 6 Weine je Quartal</p>
                      ...
                      >
                        ... Unschlagbar: 3 oder 6 Spitzenweine pro Quartal -
                        frei Haus!
                      </div>
                      <p class="my-4">
                        <i style={{ fontSize: "16px" }}>
                          Unsere gesamte Genussexpertise in einem Wein-Abonemment:
                          Mit unseren 3er- oder 6er-Kisten, die wir mit viel
                          Akribie für Sie kuratieren, möchten wir sie einmal im
                          Quartal beglücken und Ihren persönlichen Wein-Cosmos
                          erweitern. Lassen Sie sich positiv überraschen! Jetzt abonnieren!
                          {/* <a
                            className={"text-primary"}
                            style={{ cursor: "pointer" }}
                            onClick={() => setActiveTestimonial("stengel")}
                    ...
                    <div class="col-md-5 col-lg-6 p-2 pb-md-5 ms-lg-auto">
                      <div class="my-auto text-center">
                        <img
                          class=" border-radius-md my-auto"
                          src="https://bcassets.s3.amazonaws.com/static/images/Weinkiste.original.png"
                          alt="First slide"
                          style={{
                            objectFit: "cover",
                            width: "500px",
        ...
        <div class="mod mb-5 mb-sm-3 pb-5 pt-5">
            <div class="mod-i">
              <div>
                <div
                ...
                >
                  <h2 className={"h3 mt-5"} style={{ fontSize: "24px", fontWeight: "bold"  }}>
                    Nur die Weine sind eine Überraschung - garantiert! 
                  </h2>
                  <p style={{ fontSize: "18px", fontWeight: "bold" }}>
                    Beim Cru Club steht die Freude am Wein an erster Stelle - wir bieten Ihnen deshalb die volle Flexibilität.
                  </p>
        ...
        <div
          ...
          style={{
            ...
            height: "70vh",
            backgroundImage:
              "url('https://bcassets.s3.amazonaws.com/static/images/pexels-cottonbro-studio-3171815.original.jpg')",
          }}
          id="pricing-3"
        >
          <div
