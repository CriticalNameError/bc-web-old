          ...
          <div id="fullpage-wrapper">
            ...
            <div className="section fp-auto-height-responsive section1 ">
              <div class="container mt-md-n5 mt-sm-0">
                ...
                >
                  <h2 className={"heading"}>Die Zahlen sprechen für sich...</h2>
                  <p className={"h5"}>
                    Der Liv-Ex Fine <br className={"d-inline d-lg-none"} /> Wine
                    1000 Index
                  </p>
                </div>
              </div>
                ...
                <div className={"pull-right"}>
                  ...
                  >
                    <div className={"mr-0 mr-md-5 text-justify"}>
                      ...
                      <p>
                        Ein Blick auf die letzten 16 Jahre des Liv-Ex Fine Wine
                        1000 Index zeigt, dass Wein aufgrund seiner stabilen
                        Wertzuwächse eine echte Alternative zu traditionellen
                        Sachanlagen darstellt.
                      </p>
                    </div>
                  </p>
                </div>
            ...
            <div className="section fp-auto-height-responsive text-center">
              <div class="container mt-md-n5 mt-sm-0 tect-center">
                ...
                <p>
                  Hochklassige Weine werden aufgrund einfacher Wirkmechanismen
                  im Laufe der Jahre immer wertvoller. Das macht Wein für
                  langfristig planende Anleger zu einer attraktiven
                  Anlagemöglichkeit.
                </p>
                    ...
                    <div class="info info-horizontal">
                      <div class="card p-3">
                        ...
                        <p class="text-justify">
                          ...
                          Produktion zu begrenzen. Premiumweine, die
                          gleichzeitig auch investmentwürdige Weine sind, machen
                          weniger als 1 % der Produktion hochklassiger Weine
                          weltweit aus.
                          <br />
                          <br />
                          Die Tatsache, das exquisite Weine nur in einem
                          begrenzten Umfang zu Verfügung stehen und diese Menge
                          darüber hinaus aufgrund des Konsums einem natürlichen
                          Schwund unterliegt, hat die Preise für die besten
                          Weine schon immer steigen lassen.
                          <br />
                          <br />
                          Das weltweite Netzwerk von Berghaus & Cie. bietet
                          Ihnen einen exklusiven Zugang zu erstklassigen und
                          seltenen Weine, die für ein Weininvestment oder den
                          unmittelbaren Trinkgenuss bestens geeignet sind.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="info info-horizontal">
                      <div class="card p-3">
                        ...
                        <p class="text-justify">
                          ...
                          Entwicklungspotenzial, welches sie erst nach vielen
                          Jahren und teilweise sogar erst Jahrzehnten
                          angemessener Lagerung voll ausschöpfen können. Daher
                          sollte Wein, um seine Qualität nicht negativ zu
                          beeinflussen, stets unter idealen Bedingungen gelagert
                          werden.
                          <br />
                          <br />
                          ...
                          Weine in einem ideal klimatisierten und gesicherten
                          Lager in Belgien einzulagern. Das sind beste
                          Voraussetzungen für einen Weiterverkauf oder den
                          Trinkgenuss nach einer angemessenen Lagerdauer.{" "}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="info info-horizontal">
                      <div class="card p-3">
                        ...
                        <p class="text-justify">
                          ...
                          hochklassigen Weinen den Markt. Je besser ein Wein mit
                          dem Alter wird, desto begehrenswerter - und damit
                          wertvoller - wird er.
                          <br />
                          <br />
                          Der Konsum von guten Weinen und die Seltenheit
                          bestimmter Jahrgänge treibt den Preis weiter nach
                          oben. Immer mehr Investoren suchen nach einer immer
                          geringer werdenden Anzahl von Flaschen. Diese
                          Situation verschärft sich noch durch eine ständig
                          wachsende weltweite Nachfrage nach diesem besonderen
                          Vermögenswert.
                          <br />
                          <br />
                          Für ein erfolgreiches Weininvestment ist es
                          wesentlich, den Aspekt Angebot und Nachfrage immer im
                          Blick zu behalten.
                          <br />
                          <br />
                          Wir von Berghaus & Cie. nehmen uns Zeit für Sie und
                          beraten Sie so ausführlich wie Sie es sich wünschen.
                          Wir empfehlen Ihnen die Weine, die für Ihr
                          persönliches Weinportfolio am besten geeignet sind.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            >
              <div class="container mt-md-n5 mt-sm-5 mb-sm-5 pb-5">
                ...
                <Accordion allowZeroExpanded={true} className={"pt-4"}>
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        ...
                        Anleger, die auf schnelle Gewinne aus sind, sollten sich
                        von Wein fernhalten. Beim Weininvestment ist Zeit der
                  ...
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      ...
                      <p>
                        Liv-Ex (Londons International Vintners Exchange) wurde
                        im Jahr 2000 durch die beiden Börsenmakler Justin Gibbs
                        und James Miles gegründet. Die Wein-Handelsplattform mit
                        Sitz in London startete mit 10 Gründungsmitgliedern und
                        dem Ziel, den Markt für hochklassige und exquisite Weine
                        transparenter, effizienter und sicherer zu gestalten.
                      </p>
                      <p>
                        Heute bietet Liv-ex die größte Datenbank im Wein Sektor
                        und präsentiert diverse Indizes, an denen sich die
                        gesamte Branche orientiert. Liv-Ex zählt mittlerweile
                        400 Mitglieder in 36 Ländern. Die Services von Liv-Ex
                        stehen ausschließlich Händlern zur Verfügung. Berghaus &
                        Cie. nutzt diese zuverlässige Quelle, um Ihnen
                        qualitativ aufbereitete Marktzahlen und Analysen
                        bereitzustellen
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        Der einfachste Weg, die zweifelsfreie Herkunft eines
                        Weines nachzuweisen, ist die Lagerung in Holzkisten
                        (OHK) unter Zollverschluss in einem Zolllager. Berghaus
                        & Cie. nutzt ein Zolllager in Belgien, das strengen
                        Regeln unterliegt. Das Ergebnis ist ein Prüfpfad für
                        jeden unter Zollverschluss eingelagerten Wein, der Ihnen
                        eine solide Methode zur Rückverfolgung der Herkunft
                        bietet.
                      </p>
                      <p>
                        Darüberhinaus bietet Ihnen unser Zolllager durch
                        sorgfältige Regulierung von Temperatur, Feuchtigkeit und
                        anderen mikroklimatischen Faktoren die optimale Umgebung
                        für die Lagerung Ihrer Weine.
                      </p>
                      <p>
                        Weine, die unter Zollverschluss gelagert werden, sind
                        nicht mehrwertsteuerpflichtig, da sie als "im Transit"
                        betrachtet werden. Eine Kiste Wein kann mehrmals den
                        Besitzer wechseln, ohne das Zolllager jemals zu
                        verlassen, wodurch das Risiko von Schäden und Störungen
                        beseitigt wird. Als Besitzer von Wein, der in einem
                        Zolllager gelagert wird, erhalten Sie ein Zertifikat,
                        das Ihr Eigentum als physisches Gut belegt – das ein
                        bedeutender Vorteil gegenüber nicht-physischen Gütern
                        wie Aktien, die außer dem Papier, auf dem sie gedruckt
                ...
                <p className={"text-justify"}>
                  Die Firma Berghaus & Cie. GmbH ist ein Weinhandelsunternehmen,
                  das Kunden zu ihren Weinen Vergleichswerte in der preislichen
                  ...
                  individuelle steuerliche Fragen wenden Sie sich bitte an einen
                  Steuerberater. Es gelten die Allgemeinen Geschäftsbedingungen
                  der Berghaus & Cie. GmbH, eine aktuelle Fassung finden Sie
                  unter https://www.berghaus-cie.com/agb.
                </p>
              </div>
            </div>
