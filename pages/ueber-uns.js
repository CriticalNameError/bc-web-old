                  ...
                  <div className={"section fp-auto-height-responsive"}>
                    <div className={"container pt-5 pt-md-0"}>
                      <div class="row pb-2 text-center">
                        ...
                        <h1>Über uns </h1>
                          <p className="h4">
                            Erfahren Sie mehr über die Menschen hinter Berghaus
                            & Cie. und Ihre Motivation.
                          </p>
                        </div>
                          ...
                          <div class="info info-horizontal">
                            <div class="card p-3">
                              ...
                              <p class="text-justify">
                                ...
                                Leidenschaft für exquisite Weine, sondern auch
                                ein gutes Gespür für lukrative Investments.
                                Unser Team besteht aus ganz unterschiedlichen
                                Persönlichkeiten, deren berufliche Expertise und
                                individuelle Sichtweisen sich gegenseitig
                                ergänzen und bereichern. Wir teilen gemeinsame
                                Werte und sind stets auf der Suche nach der
                                besten Lösung.
                              </p>
                            </div>
                          </div>
                    ...
                    <div class="container mt-md-n5 mt-sm-5 my-auto">
                      <div class="row">
                        ...
                        >
                          <img
                            src={
                              "/assets/img/tristan_berghaus_berghaus_cie.png"
                            }
                            class={"img-raised"}
                            width="350px"
                          ></img>
                        ...
                        <div class="col-md-8 col-sm-12 text-left card mt-sm-4 mx-3 p-3 pt-5 pt-sm-4 ">
                          ...
                          <p>
                            ...
                            >
                              <p style={{ width: "250px" }}>
                                Der Wine and Spirit Education Trust (WSET) ist
                                ein international renommierter Anbieter für
                                Wein- und Spirituosen-Ausbildungen und bietet
                                seit über 40 Jahren spezielle Qualifikationen
                                für Weinkenner an.
                              </p>
                            </ReactTooltip>{" "}
                          ...
                          <p>
                            ...
                            kontinuierlich vertieft. Neben seiner
                          ...
                          <p>
                            In seiner Freizeit trifft man ihn auf der Driving
                            Rage oder auf dem Platz.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row pb-2">
                        ...
                        <div class="col-md-8 col-sm-12 text-left card mt-sm-4 mx-3 p-3 pt-5 pt-sm-4 ">
                          ...
                          <p>
                            ...
                            Statistik und VWL studiert. Er besitzt einen
                            Bachelor in Mathematik der Universität zu Köln. Als
                            Unternehmensberater für Data Science und Data
                            Engineering war er hauptsächlich in der
                            Finanzdienst- leistungsbranche (Banken und
                          ...
                          <p>
                            ...
                            erarbeitet er wertvolle Kennzahlen und Trends für
                            die Investmententscheidungen unserer Kunden. Darüber
                            hinaus ist er bei Berghaus & Cie. für die
                            Entwicklung der Handelsplattform und die internen
                            Systeme zuständig.
                          </p>
                          <p>
                      ...
                      <div class="row pb-2">
                        ...
                        <div class="col-md-8 col-sm-12 text-left card mt-sm-4 mx-3 p-3 pt-5 pt-sm-4 ">
                          ...
                          <p>
                            ...
                            Schwerpunkt Supply Chain Management der Universität
                            zu Köln.
                          </p>
                          <p>
                            Bei Berghaus & Cie. ist er aufgrund seines
                            Organisationstalentes für die Logistik und optimale
                            Lagerung der Weine sowie für die
                            unternehmensinternen Prozesse zuständig. Er besitzt
                            das Zertifikat WSET® Level 2, Award in Wine, des{" "}
                            <i data-tip data-for="global">
                              {" "}
                              Wine and Spirit Education Trust (WSET).
                            </i>
                      ...
                      <div class="row pb-2">
                        ...
                        <div class="col-md-8 col-sm-12 text-left card mt-sm-4 mx-3 p-3 pt-5 pt-sm-4 ">
                          ...
                          <p>
                            ...
                            (Markenstrategie/-aufbau), das Corporate Design
                            sowie die Entwicklung und Durchführung der
                            begleitenden Marketing- und Kommunikationsmaßnahmen
                            zuständig.
                          </p>
                          <p>
                          ...
                          <div class="info info-horizontal">
                            <div class="card p-3">
                              ...
                              <p class="rext-justify">
                                ...
                                darüber hinaus auch einen greifbaren
                          ...
                          <div class="info info-horizontal">
                            <div class="card p-3">
                              ...
                              <p class="text-justify">
                                ...
                                für jeden zugänglich machen. Dabei setzen wir
                                auf Transparenz, datenbasierte Analysen und
                                Digitalisierung.
                              </p>
                            </div>
                          </div>
                        ...
                        <div class="col-md-8 offset-md-2 col-sm-12">
                          <div class="info info-horizontal">
                            <div class="card p-3">
                              ...
                              <p class="text-justify">
                                Basierend auf den Erfahrungswerten der
                                vergangenen Jahrzehnte, aktuellen statistischen
                                Analysen und datengetriebenen
                                Technologielösungen, richten wir unsere
                                Weinempfehlungen auf Sie ganz persönlich aus.
                                Wir sorgen dafür, dass Ihr Wein-Portfolio
