  ...
  return (
    <>
       <div id={"form-container"} dangerouslySetInnerHTML={{
        __html: `<button style="background: #bfac82; font-size: 18px; color: white; font-weight: bold" onclick="nhform('show', true)" class="btn btn-light">Individuell beraten lassen!</button>`}}>
