...
function RouteAlert(props) {
	...
	<g fill={secondaryfill} stroke={secondaryfill} strokeMiterlimit="10">
		...
		<circle cx="32" cy="39" fill={secondaryfill} r="1" strokeLinejoin="miter"/>
		...
		<line fill="none" stroke={secondaryfill} strokeLinecap="square" strokeLinejoin="miter" strokeWidth={strokewidth} x1="32" x2="32" y1="25" y2="33"/>
	</g>
</svg>
	);
};
