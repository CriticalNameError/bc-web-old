...
function BulbAnimated(props) {
	...
	<g fill={secondaryfill} stroke={secondaryfill} strokeLinecap="square" strokeLinejoin="miter" strokeMiterlimit="10" strokeWidth={strokewidth}>
		...
		<line  class="animated fadeIn slower" fill="none" stroke={fill} x1="25" x2="39" y1="62" y2="62"/>
		<path class="animated fadeIn slower" d="M49,32 c0-9.389-7.611-17-17-17s-17,7.611-17,17c0,6.891,4.107,12.81,10,15.48V56h14v-8.52C44.893,44.81,49,38.891,49,32z" fill="none" stroke={fill}/>
	</g>
</svg>
	);
};
