...
function RouteClose(props) {
	...
	<g fill={secondaryfill} stroke={secondaryfill} strokeMiterlimit="10">
		...
		<line fill="none" stroke={secondaryfill} strokeLinecap="square" strokeLinejoin="miter" strokeWidth={strokewidth} x1="28" x2="36" y1="28" y2="36"/>
		<line fill="none" stroke={secondaryfill} strokeLinecap="square" strokeLinejoin="miter" strokeWidth={strokewidth} x1="36" x2="28" y1="28" y2="36"/>
	</g>
</svg>
	);
};

export default RouteClose;